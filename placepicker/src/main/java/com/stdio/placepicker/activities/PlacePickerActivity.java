package com.stdio.placepicker.activities;
...
import com.stdio.placepicker.R;
import com.stdio.placepicker.models.AddressData;
import com.stdio.placepicker.utilities.Constants;
import com.stdio.placepicker.utilities.CurrentPlaceSelectionBottomSheet;
import com.stdio.placepicker.utilities.PermissionUtility;
...
public class PlacePickerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void initViews() {
        ...
        toolbarLayout = findViewById(R.id.ll_test);
        if (!showSearchBar) {
...
//            Places.initialize(this, getResources().getString(R.string.google_maps_api_key));
    ...
    private void getIntentData() {
        if (getIntent() != null) {
            ...
            this.showSearchBar = this.getIntent().getBooleanExtra(Constants.SHOW_SEARCH_BAR_INTENT, false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode) {
            case Constants.AUTOCOMPLETE_PLACE_PICKER_REQUEST:
                System.out.println(Autocomplete.getPlaceFromIntent(data));
