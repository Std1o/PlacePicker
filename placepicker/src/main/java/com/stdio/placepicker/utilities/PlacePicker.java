package com.stdio.placepicker.utilities;
...
import com.stdio.placepicker.activities.PlacePickerActivity;
...
public class PlacePicker {
    ...
    public static class IntentBuilder {
        ...
        public final IntentBuilder showSearchBar(boolean showSearchBar) {
        ...
        public final Intent build(Activity activity) {
            ...
            intent.putExtra(Constants.SHOW_SEARCH_BAR_INTENT , this.showSearchBar);
